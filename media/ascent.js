...
function say(text,tone){commsEl.textContent=text;commsEl.classList.remove("st-comms-good","st-comms-bad");if(tone==="good"){commsEl.classList.add("st-comms-good-90795726");}
if(tone==="bad"){commsEl.classList.add("st-comms-bad-90795726");}}
...
function logFlight(value,won){var li=document.createElement("li");li.className="st-log-entry-90795726"+
